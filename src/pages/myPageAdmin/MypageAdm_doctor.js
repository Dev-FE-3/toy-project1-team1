...
export default function myPageAdm_doctor() {
  // DOM이 완전히 로드된 후에 초기화
    ...
    <ul class="firstDate">
      <li class="dataOfJoining">
        <div class="infoWrap">
          입사일
          <span class="dot">
            <input class="detailInfoEdit" id="employee1_dataOfJoining" type="text" disabled value="2021.03.21">
          </span>
        </div>
      </li>
      <li class="rank">
        <div class="infoWrap">
          직급
          <span class="dot">
            <input class="detailInfoEdit" id="employee1_rank" type="text" disabled value="원장">
          </span>
        </div>
      </li>
      <li class="email">
        <div class="infoWrap">
          이메일
          <span class="dot">
            <input class="detailInfoEdit" id="employee1_email" type="text" disabled value="woomiyeon@naver.com">
          </span>
        </div>
      </li>
    </ul>
    ...
    <ul class="secondDate">
      <li class="phoneNumber">
        <div class="infoUnderline">
          ...
          <div class="infoWrap">
            <span class="dot">
              <input class="detailInfoEdit" id="employee1_phoneNumber" type="text" disabled value="010-2847-9365">
            </span>
          </div>
        </div>
      </li>
      <li class="HomeAddress">
        <div class="infoUnderline">
          ...
          <div class="infoWrap">
            <span class="dot">
              <input class="detailInfoEdit" id="employee1_HomeAddress" type="text" disabled value="경기도 성남시 북창로 12">
            </span>
          </div>
        </div>
      </li>
      <li class="birthDate">
        <div class="infoUnderline">
          ...
          <div class="infoWrap">
            <span class="dot">
              <input class="detailInfoEdit" id="employee1_birthDate" type="text" disabled value="1980.01.01">
            </span>
          </div>
        </div>
      </li>
